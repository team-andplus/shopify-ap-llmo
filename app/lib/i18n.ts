...
export const translations = {
  ja: {
    ...
    aiContextDesc: "AI がストアを解釈する際のルール・制約を定義するプロトコルファイルです。llms.txt と同様に AI 生成・対話的な編集ができます。",
  ...
  en: {
    ...
    aiContextDesc: "A protocol file defining rules and constraints for how AI should interpret your store. Like llms.txt, you can generate with AI and refine interactively.",
