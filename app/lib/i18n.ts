...
export const translations = {
  ja: {
    ...
    llmsFullTxtSectionTitle: "llms.full.txt（ストア情報の自動生成）",
    llmsFullTxtDesc: "コレクション・商品・ロケーション・ポリシー等をまとめた llms.full.txt を自動生成します。「AI で整形」をオンにすると冗長な部分を整理します。",
    ...
    aiContextSectionTitle: ".ai-context（AI 解釈ガイドライン）",
    aiContextDesc: "llms.full.txt 生成時に .ai-context も自動生成されます。AI がストアを解釈する際のルール・制約を定義します。",
    aiContextUrl: ".ai-context の URL",
    aiContextGeneratedAt: "最終生成",
    aiContextNotSet: "未生成",
    aiContextSet: "生成済み",
    accessLogNav: "アクセスログ",
    accessLogTitle: "App Proxy アクセスログ",
    accessLogDesc: "llms.txt 等へのアクセスを log/llmo-access.log から都度集計して表示しています。",
  ...
  en: {
    ...
    llmsFullTxtSectionTitle: "llms.full.txt (auto-generated store info)",
    llmsFullTxtDesc: "Auto-generates llms.full.txt containing collections, products, locations, policies, etc. Enable \"Refine with AI\" to clean up redundant content.",
    ...
    aiContextSectionTitle: ".ai-context (AI interpretation guidelines)",
    aiContextDesc: "When generating llms.full.txt, .ai-context is also auto-generated. Defines rules and constraints for how AI should interpret your store.",
    aiContextUrl: ".ai-context URL",
    aiContextGeneratedAt: "Last generated",
    aiContextNotSet: "Not generated",
    aiContextSet: "Generated",
    accessLogNav: "Access log",
    accessLogTitle: "App Proxy access log",
    accessLogDesc: "Access to llms.txt etc. is aggregated on demand from log/llmo-access.log.",
